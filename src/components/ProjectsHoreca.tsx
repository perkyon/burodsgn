    ...
    <section id="horeca" className="bg-white w-full py-12 md:py-20">
      <div className="w-full px-4 md:px-8">
        <h2 className="font-['Unbounded'] text-[27px] md:text-[45px] text-[#141414] text-center mb-6 md:mb-8">
          ...
          <span className="text-[35px] md:text-[45px]">H</span>
          <span className="text-[27px] md:text-[40px]">o</span>
          <span className="text-[35px] md:text-[45px]">R</span>
          <span className="text-[27px] md:text-[40px]">e</span>
          <span className="text-[35px] md:text-[45px]">C</span>
          <span className="text-[27px] md:text-[40px]">a</span>
        </h2>
