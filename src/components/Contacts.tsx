  ...
  return (
    <section id="contacts" className="bg-white w-full py-12 md:py-20">
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8">
        <div className="font-['Unbounded'] text-[32px] md:text-[50px] lg:text-[60px] text-black mb-6 md:mb-8">
        ...
        <div className="flex justify-center mb-12 md:mb-20">
          <button className="bg-[#141414] px-12 md:px-16 py-3 md:py-4 rounded-md hover:bg-[#2a2a2a] transition-colors">
            <span className="font-['Unbounded'] text-[26px] md:text-[30px] text-[rgba(255,255,255,0.8)]">
              Оставьте заявку
            </span>
          </button>
        </div>
        ...
        <div className="bg-[#141414] py-8 md:py-12 px-6 md:px-16 rounded-lg">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8">
            <div className="text-center md:text-left">
              <p className="font-['Unbounded'] text-[25px] md:text-[30px] text-white mb-2">+7 (928) 241-27-20</p>
              <p className="font-['Unbounded'] text-[25px] md:text-[30px] text-white">sales@burodsgn.ru</p>
            </div>
            
            <div className="text-center">
              <p className="font-['Unbounded'] text-[21px] md:text-[26px] text-white mb-2">
                <span className="text-[26px] md:text-[30px]">К</span>
                <span>раснодар, ул. Дальний пр., 11, корп. 1, этаж 2</span>
              </p>
              <p className="font-['Unbounded'] text-[18px] md:text-[23px] text-white">
                Режим работы:<br />
          ...
          <div className="text-center mb-4 md:mb-6">
            <p className="font-['Unbounded'] text-[18px] md:text-[21px] text-[rgba(255,255,255,0.7)]">2028</p>
            <p className="font-['Unbounded'] text-[18px] md:text-[21px] text-[rgba(255,255,255,0.7)]">ООО "БЮРО 23"</p>
            <p className="font-['Unbounded'] text-[18px] md:text-[21px] text-[rgba(255,255,255,0.7)]">Все права защищены</p>
          </div>

          <div className="w-full h-px bg-white mb-4" />

          <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-8 text-center">
            <p className="font-['Unbounded'] text-[18px] md:text-[21px] text-[rgba(255,255,255,0.7)]">Юридическая информация</p>
            <p className="font-['Unbounded'] text-[18px] md:text-[21px] text-[rgba(255,255,255,0.7)]">Юридическая информация</p>
            <p className="font-['Unbounded'] text-[18px] md:text-[21px] text-[rgba(255,255,255,0.7)]">Политика конфиденциальности</p>
          </div>
        </div>
      </div>
    </section>
