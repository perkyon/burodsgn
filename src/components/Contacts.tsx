  ...
  return (
    <section id="contacts" className="bg-white w-full py-12 md:py-20">
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8">
        <div className="font-['Unbounded'] text-[40px] md:text-[60px] lg:text-[70px] text-black mb-6 md:mb-8">
        ...
        <div className="flex justify-center mb-12 md:mb-20">
          <button className="bg-[#141414] px-12 md:px-16 py-3 md:py-4 rounded-md hover:bg-[#2a2a2a] transition-colors">
            <span className="font-['Unbounded'] text-[32px] md:text-[36px] text-[rgba(255,255,255,0.8)]">
              Оставьте заявку
            </span>
          </button>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8">
              ...
              <div className="text-center md:text-right md:flex md:flex-col md:items-end">
                <p className="font-['Unbounded'] text-white mb-1">
                  <span className="text-[24px] md:text-[28px]">BURO</span>
                  <span className="text-[20px] md:text-[24px]"> digital</span>
                </p>
                <p className="font-['Unbounded'] text-white mb-1">
                  <span className="text-[24px] md:text-[28px]">BURO </span>
                  <span className="text-[20px] md:text-[24px]">dsgn</span>
                </p>
                <p className="font-['Unbounded'] text-white">
                  <span className="text-[24px] md:text-[28px]">BURO</span>
                  <span className="text-[20px] md:text-[24px]"> crm</span>
                </p>
              </div>
            </div>
