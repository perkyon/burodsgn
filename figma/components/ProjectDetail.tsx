...
function SocialIcons() {
  return (
    <a href="https://t.me/burodsgn" target="_blank" rel="noopener noreferrer" className="absolute h-[25.599px] left-[595px] top-[189px] w-[34.076px] hover:opacity-70 transition-opacity" data-name="Social Icons">
